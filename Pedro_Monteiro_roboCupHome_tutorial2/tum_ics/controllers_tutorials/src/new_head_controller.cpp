...
class New_head_controller : public controller_interface::ControllerBase
{
public:
                   ...
                   ClaimedResources&       claimed_resources)
  {
    ...
    // success
    state_ = INITIALIZED;//ControllerState::
    return true;
  }
...
PLUGINLIB_EXPORT_CLASS( controllers_tutorials::New_head_controller, controller_interface::ControllerBase);
